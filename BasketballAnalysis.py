# -*- coding: utf-8 -*-
"""
Created on Tue May 12 15:36:26 2020
...
Dic1 = {"KobeBryant":0 ,"JoeJohnson":1,"LeBronJames":2,"CarmeloAnthony":3,"DwightHoward":4,"ChrisBosh":5,"ChrisPaul":6,"KevinDurant":7,"DerrickRose":8,"DwayneWade":9}
...
FT = np.array([KobeBryant_FT,JoeJohnson_FT,LeBronJames_FT,CarmeloAnthony_FT,DwightHoward_FT,ChrisBosh_FT,ChrisPaul_FT,KevinDurant_FT,DerrickRose_FT,DwayneWade_FT])
...
FTA = np.array([KobeBryant_FTA,JoeJohnson_FTA,LeBronJames_FTA,CarmeloAnthony_FTA,DwightHoward_FTA,ChrisBosh_FTA,ChrisPaul_FTA,KevinDurant_FTA,DerrickRose_FTA,DwayneWade_FTA])

def myPlot(data,itemList = Players):
    Col = {"KobeBryant":"green" ,"JoeJohnson":"blue","LeBronJames":"red","CarmeloAnthony":"cyan","DwightHoward":"magenta","ChrisBosh":"yellow","ChrisPaul":"black","KevinDurant":"yellow","DerrickRose":"magenta","DwayneWade":"green"}
    mk = {"KobeBryant":"1" ,"JoeJohnson":"2","LeBronJames":"3","CarmeloAnthony":"4","DwightHoward":"8","ChrisBosh":"s","ChrisPaul":"p","KevinDurant":"o","DerrickRose":"v","DwayneWade":"h"}
    for name in itemList:
        plt.plot(data[Dic1[name]],C = Col[name] ,ls = '--',marker = mk[name] , label = name)
